...
class List extends React.Component {
  ...
  handleDeleteButtonClick = () => {
    ...
    if (renderedBoard && renderedBoard.lists) {
      ...
      // console.log("coi ho xoa cai chi",newState.lists[this.props.list.id]);
      //{id: 'cMz9GYRyW', title: 'fadsfas', taskIds: Array(2)}

      // console.log("coi ho xoa cai chi",newState.lists[this.props.list.id].taskIds);
      //['task-8f0f8fab-bfe4-4e9f-b537-54ccd685a99b', 'task-2fd4ddd9-5761-4abb-ae46-5e98ab5cd257']
      
      
      delete newState.lists[this.props.list.id];
      ListHelpers.HandleDeletingList(renderedBoard, this.props.list.id, this.props.list)
        .then(() => {
          console.log("test",renderedBoard.lists, this.props.list)
          setRenderedBoard(newState);
          console.log("coi co con list k",newState.lists[this.props.list.id])
        })
