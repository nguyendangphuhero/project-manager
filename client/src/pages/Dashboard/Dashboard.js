...
export const Dashboard = () => {
  ...
  if(dataset==null){
    console.log("null roi chu")
     ...
     console.log("list_tasks",list_tasks) 
  ...
  const transactionHistoryData = {
    labels: ["ToDo", "In progess", "Done", "OverDue"],
    datasets: [{
      data: mang_bieudo,
      backgroundColor: [
  ...
  return (
    ...
    <div className="nentrang"> 
      ...
      <div className="row">
        ...
        <div className="col-md-6 grid-margin stretch-card nentrang">
          <div className="card ">
            <div className="card-body">
          ...
          <div className="card-body">
            ...
            <div className="aligner-wrapper">
              ...
              <div className="absolute center-content">
                <h5 className="font-weight-normal text-whiite text-center mb-2 ">{sumArray(mang_bieudo)}</h5>
            ...
            <div className="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3 maunentrang">
              <div className="text-md-center text-xl-left ">
                <h6 className="mb-1 mauchu">To Do</h6>
                {/* <p className="text-muted mb-0">07 Jan 2019, 09:12AM</p> */}
              </div>
              <div className="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0 maunentrang">
            ...
            <div className="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3 maunentrang">
              <div className="text-md-center text-xl-left">
                <h6 className="mb-1 mauchu">In Progess</h6>
                {/* <p className="text-muted mb-0">07 Jan 2019, 09:12AM</p> */}
              </div>
              <div className="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0 maunentrang">
